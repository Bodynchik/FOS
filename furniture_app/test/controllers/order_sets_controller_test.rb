...
class OrderSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_set" do
    assert_difference("OrderSet.count") do
      post order_sets_url, params: { order_set: { prodset_id: @order_set.prodset_id, total_price: @order_set.total_price } }
    end
  ...
  test "should update order_set" do
    patch order_set_url(@order_set), params: { order_set: { prodset_id: @order_set.prodset_id, total_price: @order_set.total_price } }
