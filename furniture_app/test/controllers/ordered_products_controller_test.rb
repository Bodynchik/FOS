...
class OrderedProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordered_product" do
    assert_difference("OrderedProduct.count") do
      post ordered_products_url, params: { ordered_product: { order_id: @ordered_product.order_id, prod_amount: @ordered_product.prod_amount, prod_id: @ordered_product.prod_id } }
    end
  ...
  test "should update ordered_product" do
    patch ordered_product_url(@ordered_product), params: { ordered_product: { order_id: @ordered_product.order_id, prod_amount: @ordered_product.prod_amount, prod_id: @ordered_product.prod_id } }
