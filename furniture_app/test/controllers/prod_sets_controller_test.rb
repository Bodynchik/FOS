...
class ProdSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prod_set" do
    assert_difference("ProdSet.count") do
      post prod_sets_url, params: { prod_set: { prod_data: @prod_set.prod_data, set_name: @prod_set.set_name, user_id: @prod_set.user_id } }
    end
  ...
  test "should update prod_set" do
    patch prod_set_url(@prod_set), params: { prod_set: { prod_data: @prod_set.prod_data, set_name: @prod_set.set_name, user_id: @prod_set.user_id } }
